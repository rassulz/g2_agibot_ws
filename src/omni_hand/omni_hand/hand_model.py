...
# --- gestures ---------------------------------------------------------------
#
# Generated by tools/dump_gestures.py from the AgiLink OmniHand SDK 1.1.8
# kinematics solver -- AgiBot's own poses, not guesses. Do not hand-edit.
#
...
# What rock, paper and scissors mean per model. O10 has two fists; fist1 is
# the plain one. O12's thumb on the left-hand fist comes back all zeros from
# the solver while the right is curled -- looks like an SDK quirk, so check
# the left hand visually before trusting it.
RPS = {
    'o10_t2': {'rock': 'fist1', 'paper': 'paper', 'scissors': 'num2'},
